...
public class AboutPrimitives {
	...
	public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
		...
		assertEquals(1.0e3,Double.parseDouble("1.0e3"));
		assertEquals(1E3, Double.parseDouble("1E3"));
	}
	...
	public void primitivesOfTypeFloatCanBeDeclaredWithExponents() {
		...
		assertEquals(1.0e3f,Float.parseFloat("1.0e3f"));
		assertEquals(1E3f, Float.parseFloat("1E3F"));
	}
