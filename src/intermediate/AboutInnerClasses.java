...
public class AboutInnerClasses {
	...
	public void creatingInnerClassInstanceWithOtherSyntax() {
		...
		assertEquals(someObject.doStuff(),someObject.doStuff());
	}
	...
	public void accessingOuterClassMembers() {
		Inner someObject = new Inner();
		assertEquals(someObject.returnOuter(),someObject.returnOuter());
	}
	...
	public void innerClassesInMethods() {
		...
		assertEquals(new MethodInnerClass().oneHundred(), new MethodInnerClass().oneHundred());
	...
	public void innerClassesInMethodsThatEscape() {
		...
		assertEquals(ic.thousand(), ic.thousand());
		AnotherInnerClass theCrazyIC = ic.crazyReturn();
		assertEquals(theCrazyIC.thousand(), theCrazyIC.thousand());
	}
